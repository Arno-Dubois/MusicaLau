...
/**
 * A variable controlling whether controller used with the Apple TV generate
 * UI events.
 *
 ...
 *
 * More information about properly making use of controller for the Apple TV
 * can be found here:
 * https://developer.apple.com/tvos/human-interface-guidelines/remote-and-controller/
 *
 * The variable can be set to the following values:
 *
...
/**
 * A variable controlling whether DirectInput should be used for controller.
 *
 * The variable can be set to the following values:
 *
...
/**
 * If set, all devices will be skipped when scanning for game controller
 ...
 * - "1": Sensor fusion is enabled for all controller that lack sensors
 *
 ...
 * devices or only controller.
 *
 * The variable can be set to the following values:
 *
 * - "0": SDL_hid_enumerate() will enumerate all HID devices.
 * - "1": SDL_hid_enumerate() will only enumerate controller. (default)
 *
 * By default SDL will only enumerate controller, to reduce risk of hanging
...
/**
 * A variable containing a list of arcade stick style controller.
 *
 * The format of the string is a comma separated list of USB VID/PID pairs in
 * hexadecimal form, e.g.
 *
 ...
 * controller and gyro on Nintendo Switch controller, but break Windows
 ...
 * controller without power cycling the controller.
 *
 * The variable can be set to the following values:
 *
...
/**
 * A variable containing a list of flightstick style controller.
 *
 * The format of the string is a comma separated list of USB VID/PID pairs in
 * hexadecimal form, e.g.
 *
...
/**
 * A variable controlling whether Nintendo Switch Joy-Con controller will be
 * combined into a single Pro-like controller when using the HIDAPI driver.
 *
 * The variable can be set to the following values:
 *
 * - "0": Left and right Joy-Con controller will not be combined and each
 *   will be a mini-gamepad.
 * - "1": Left and right Joy-Con controller will be combined into a single
 *   controller. (default)
 *
 * This hint should be set before initializing joysticks and gamepads.
 *
 ...
 * controller connected via Bluetooth should be used.
 *
 * The variable can be set to the following values:
 *
 * - "0": HIDAPI driver is not used.
 ...
 * classic controller should be used.
 *
 * The variable can be set to the following values:
 *
 * - "0": HIDAPI driver is not used.
...
/**
 * A variable controlling whether the HIDAPI driver for PS3 controller should
 * be used.
 *
 * The variable can be set to the following values:
 *
 ...
 * controller (Sixaxis/DualShock 3) should be used.
 *
 * The variable can be set to the following values:
 *
...
/**
 * A variable controlling whether the HIDAPI driver for PS4 controller should
 * be used.
 *
 * The variable can be set to the following values:
 *
...
/**
 * A variable controlling whether the HIDAPI driver for PS5 controller should
 * be used.
 *
 * The variable can be set to the following values:
 *
 ...
 * The variable can be set to the following values:
 *
 * - "0": Left and right Joy-Con controller will not be in vertical mode.
 *   (default)
 * - "1": Left and right Joy-Con controller will be in vertical mode.
 *
...
/**
 * A variable controlling whether the HIDAPI driver for XBox controller
 * should be used.
 *
 * The variable can be set to the following values:
 *
...
/**
 * A variable controlling whether the HIDAPI driver for XBox 360 controller
 * should be used.
 *
 * The variable can be set to the following values:
 *
...
/**
 * A variable controlling whether the HIDAPI driver for XBox One controller
 * should be used.
 *
 * The variable can be set to the following values:
 *
 ...
 *   presses, and rumble support for Xbox controller. (default)
 *
 * This hint should be set before a gamepad is opened.
 *
 * \since This hint is available since SDL 3.2.0.
...
/**
 * A variable containing a list of throttle style controller.
 *
 * The format of the string is a comma separated list of USB VID/PID pairs in
 * hexadecimal form, e.g.
 *
...
/**
 * A variable containing a list of wheel style controller.
 *
 * The format of the string is a comma separated list of USB VID/PID pairs in
 * hexadecimal form, e.g.
 *
